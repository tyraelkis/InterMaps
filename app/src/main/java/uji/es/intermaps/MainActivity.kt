        ...
        setContent {
            ...
            InterMapsTheme {
                Scaffold(modifier = Modifier.fillMaxSize()) { innerPadding ->
                    ...
                    NavigationWrapper(navHostController, auth, viewModel = InterestPlaceViewModel(interestPlaceService), viewModel1 = UserViewModel(userService, auth, navHostController))
